...
const OnlyFansBanner = () => {
  ...
  return (
    <>
      ...
      {/* Banner */}
      <div
        className={`fixed md:left-[5%] md:top-[40%] left-0 top-[80px] md:-translate-y-1/3 z-50 transition-transform duration-700 ease-out ${
      ...
      >
        <div className="relative">
          ...
          <button 
            onClick={toggleBanner}
            className="absolute md:-right-10 md:-top-10 -right-8 top-4 w-8 h-8 rounded-full bg-black border-2 border-[#e3cbaa] text-[#e3cbaa] flex items-center justify-center hover:bg-[#e3cbaa] hover:text-black transition-all duration-300 group z-50"
          >
            <span className="transform group-hover:rotate-180 transition-transform duration-300 text-2xl">×</span>
          </button>

          {/* Animierter Neon-Rahmen */}
          ...
          {/* Hauptbanner mit verbessertem Design */}
